    ...
    def query_agent(self, query_text: str) -> Dict:
        ...
        try:
            ...
            for chunk in retrieved_info.get('retrieved_chunks', []):
                if chunk["similarity_score"] >= STRONG_THRESHOLD:
            ...
            if context_info.strip():
                ...
                system_prompt = '''You are a book-specific assistant.

You are ONLY allowed to answer using the retrieved book content.
If no relevant information is provided, reply with:

"I don’t have information about this topic in the book."

Do NOT use general knowledge.
Do NOT answer from memory.
book info: {context_info}'''

            # Make the API call to OpenAI
            response = self.client.chat.completions.create(
                model="xiaomi/mimo-v2-flash:free",  # or gpt-4 if available
                messages=[
